(function installHomeSchoolReview(globalObject, documentObject) {
  ...
  const REVIEW_VERSION = "who-takes-care-home-school-within-child-review-r16";
  const STUDY_RUNTIME_VERSION = "chs-home-school-evelyn-v1-r16-within-child-preview-1";
