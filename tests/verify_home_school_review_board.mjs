...
const expectedRelease = "chs-home-school-evelyn-v1-r24-yellow-cleanup-1";
...
assert.match(html, /home-school-review\.js\?v=who-helps-where-review-r24/);
assert.match(html, /review\.css\?v=who-helps-where-review-r24/);
...
assert.equal(api.REVIEW_VERSION, "who-helps-where-review-r24");
