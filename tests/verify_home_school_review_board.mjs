...
assert.match(html, /home-school-review\.js\?v=who-takes-care-home-school-within-child-review-r16/);
assert.match(html, /review\.css\?v=who-takes-care-home-school-within-child-review-r16/);
...
assert.equal(api.REVIEW_VERSION, "who-takes-care-home-school-within-child-review-r16");
assert.equal(api.STUDY_RUNTIME_VERSION, "chs-home-school-evelyn-v1-r16-within-child-preview-1");
...
for (const entry of entries) {
  ...
  for (const orderValue of orderValues) {
    ...
    assert.equal(url.searchParams.get("v"), "chs-home-school-evelyn-v1-r16-within-child-preview-1");
